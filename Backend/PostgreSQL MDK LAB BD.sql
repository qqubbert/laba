...
ALTER USER postgres WITH PASSWORD 'spiritbinge';
...
INSERT INTO Employee (FirstName, LastName, Surname, Gender, Birthday, FamilyStatus, HavingChildren, JobTitle, AcademicDegree, DepID, WorkExperience, Salary)
VALUES 
('Николай', 'Романович', 'Шебалков', 'M', '2005-08-25', 'Холост', 0, 'Лаборант', 'Кандидат наук', 1, 10, 100000),
('Александр', 'Павлович', 'Наумов', 'М', '2006-08-29', 'В активном поиске', 1, 'Уборщик', 'Образование отсутствует', 1, 13, 19242),
('Сергей', 'Сергеевич', 'Степцов', 'M', '2006-06-18', 'Холост', 0, 'Лаборант', 'Бакалавр', 1, 3, 44000),
('Василий', 'Витальевич', 'Блохин', 'M', '1985-05-17', 'Разведён', 5, 'Профессор', 'Доктор наук', 2, 10, 150000),
('Матвей', 'Павлович', 'Самойличенко', 'M', '2003-08-12', 'Разведён', 0, 'Уборщик', 'Среднее профессиональное орбазование', 2, 8, 70000),
('Дмитрий', 'Павлович', 'Шабанов', 'M', '2004-08-15', 'Холост', 0, 'Инженер', 'Среднее профессиональное орбазование', 2, 4, 90000),
('Владислав', 'Витальевич', 'Морозов', 'M', '2008-02-17', 'Холост', 0, 'Лаборант', 'Основное общее образование', 3, 2, 30000),
('Мирон', 'Максимович', 'Воронин', 'M', '2009-12-18', 'Холост', 0, 'Электрик', 'Основное общее образование', 3, 0, 10000),
('Вячеслав', 'Романович', 'Иванов', 'М', '1999-10-13', 'Женат', 3, 'Профессор', 'Образование отсутствует', 3, 6, 25000),
('Кристина', 'Витальевна', 'Ивичук', 'Ж', '2007-01-12', 'Вдова', 0, 'Химик', 'Аспирант', 4, 1, 15000),
('Владислав', 'Александрович', 'Воробьёв', 'М', '2006-12-24', 'Женат', 0, 'Администратор', 'Бакалавр', 5, 2, 65000),
('Артём', 'Витальевич', 'Шум', 'М', '2006-08-14', 'Женат', 2, 'Физик', 'Бакалавр', 5, 3, 55000),
('Игорь', 'Андреевич', 'Веденеев', 'М', '2006-10-14', 'Холост', 0, 'Физик', 'Аспирант', 5, 4, 75000),
('Алексей', 'Павлович', 'Пасечников', 'М', '2003-05-04', 'Холост', 0, 'Химик', 'Аспирант', 6, 2, 75000),
('Дмитрий', 'Владимирович', 'Лукьянов', 'М', '2007-05-13', 'Холост', 0, 'Лаборант', 'Аспирант', 6, 1, 65000),
('Кирилл', 'Иванович', 'Назаров', 'М', '2007-01-09', 'Женат', 0, 'Лаборант', 'Аспирант', 6, 0, 55000),
('Нурадиль', 'Азаматович', 'Хаджанов', 'М', '2006-04-18', 'Холост', 0, 'Уборщик', 'Среднее профессиональное орбазование', 6, 3, 15000),
('Святослав', 'Сергеевич', 'Несинов', 'М', '1998-07-13', 'Холост', 0, 'Физик', 'Среднее профессиональное орбазование', 7, 0, 15000),
('Даниил', 'Владимирович', 'Витков', 'М', '1995-02-28', 'Женат', 0, 'Профессор', 'Среднее профессиональное орбазование', 9, 0, 30000),
('Георгий', 'Артемович', 'Крючихин', 'М', '1984-12-02', 'Холост', 0, 'Математик', 'Среднее профессиональное орбазование', 7, 13, 29000),
('Егор', 'Андреевич', 'Лукьянов', 'М', '1990-01-17', 'Женат', 3, 'Математик', 'Среднее профессиональное орбазование', 8, 9, 19242),
('Дмитрий', 'Сергеевич', 'Корабельников', 'М', '1962-05-29', 'Женат', 5, 'Математик', 'Среднее профессиональное орбазование', 8, 19, 190242),
('Артур', 'Давидович', 'Петросян', 'М', '1990-11-02', 'Холост', 0, 'Физик', 'Аспирант', 8, 6, 89567),
('Даниель', 'Андреевич', 'Ни', 'М', '2006-03-04', 'Холост', 0, 'Лаборант', 'Аспирант', 9, 1, 63656),
('Даниил', 'Олегович', 'Сатюков', 'М', '2005-04-29', 'Женат', 0, 'Уборщик', 'Начальное общее образование', 9, 1, 3000),
('Данила', 'Александрович', 'Демидов', 'М', '1990-12-17', 'Холост', 0, 'Директор', 'Среднее профессиональное орбазование', 9, 24, 300000),
('Василиса', 'Андреевна', 'Бочнюк', 'Ж', '2006-09-04', 'Не замужем', 0, 'Старший научный сотрудник', 'Среднее профессиональное орбазование', 10, 1, 63050),
('Анастасия', 'Игоревна', 'Егорова', 'Ж', '2000-06-03', 'Замужем', 0, 'Лаборант', 'Среднее профессиональное орбазование', 10, 2, 30000),
('Дарья', 'Тарасовна', 'Назаренко', 'Ж', '2000-03-06', 'Не замужем', 0, 'Лаборант', 'Среднее профессиональное орбазование', 10, 1, 40000),
('Абдуджафис', 'Абдурасулович', 'Бободжанов', 'М', '1945-05-09', 'Женат', 6, 'Профессор', 'Доктор наук', 11, 50, 100000);

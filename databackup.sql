...
CREATE TABLE `chat_msgs` (
  ...
  CONSTRAINT `chat_msgs_ibfk_2` FOREIGN KEY (`chat_id`) REFERENCES `chats` (`id`)
...
CREATE TABLE `chat_users` (
  ...
  CONSTRAINT `chat_users_ibfk_2` FOREIGN KEY (`chat_id`) REFERENCES `chats` (`id`)
...
INSERT INTO `chat_users` VALUES (1,1,1),(2,2,1),(3,3,2),(4,4,3),(5,5,4),(6,6,1),(7,7,2),(8,8,3),(9,9,4),(10,10,1),(11,6,5),(12,21,5),(13,13,5),(14,19,5),(15,14,5),(16,13,6),(17,2,6),(18,26,6),(19,13,1),(20,13,7),(21,22,7),(22,15,8),(23,2,8),(24,13,8),(25,14,8),(26,26,9),(27,19,9),(28,25,9),(29,24,9),(30,2,10);
...
INSERT INTO `chats` VALUES (1,'Научные исследования',NULL,1),(2,'Обсуждение проектов',NULL,3),(3,'Вопросы и ответы по биологии',NULL,4),(4,'Клинические испытания',NULL,5),(5,'Обсуждаем тачки',NULL,13),(6,'Проект',NULL,13),(7,'Заметки',NULL,13),(8,'Качалочка',NULL,13),(9,'Даньёчки правят миром',NULL,19),(10,'СВО',NULL,2);
...
INSERT INTO `fav_articles` VALUES (1,2,26),(10,4,13),(11,3,26),(15,5,26),(16,6,26),(18,4,26);
...
CREATE TABLE `msg_media` (
  ...
  UNIQUE KEY `id` (`id`),
  KEY `msg_id` (`msg_id`),
  CONSTRAINT `msg_media_ibfk_1` FOREIGN KEY (`msg_id`) REFERENCES `chat_msgs` (`id`)
...
INSERT INTO `registerkeys` VALUES (6,'k49VFdBTomzfitbp',NULL),(7,'G5E1x6bysfZQbQz9',NULL),(8,'gCOHMtsH5MLwxdz7',NULL),(9,'6alVo2PJlHqyaBvV',NULL),(10,'Tnz15P6IjxE3DA6o',NULL),(11,'6Gn5go72hzugVVl7',NULL),(12,'KmRXjKwLSTO2o6ev',NULL),(13,'P7p9sQvdImswIQJs',NULL),(14,'caotbwqktyuP8sBi',NULL),(15,'weCh7JOEe2rAu6hp',NULL),(16,'LC2iMqDJqakTONPd',NULL),(17,'McvnosjGoZj7foeK',NULL),(18,'cAJNe0yQMpA5Zqrs',NULL),(19,'Bc5jRFRqu2UzhppX',NULL),(20,'KQWfFTWEQhzJ2IcS',NULL),(21,'e0SZPUe4TqtJBr9v',NULL),(22,'1kOQTmav5W8T5ZeO',NULL),(23,'IKPcEKsoDCAIYcS0',NULL),(24,'UWa4fXLaozORnSlq',NULL),(25,'L2HKVXeddr2zby3x',NULL),(26,'nOLzihSiPzNGCQAR',NULL),(27,'F9Rn4Vx9yIi7hN9t',NULL),(28,'Io3QZXHdBlFn80PW',NULL),(29,'NpNTTFJyL8xbISsl',NULL),(30,'GFUcElU4tU5wIkTh',NULL);
...
CREATE TABLE `users` (
  ...
  `JobTitle` varchar(30) DEFAULT (_utf8mb4'Должность'),
...
-- Dump completed on 2025-01-20  9:54:39
